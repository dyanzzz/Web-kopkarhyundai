<div class="col-sm-12">
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<i class="clip-grid"></i>Form Edit Promo
		</div>
		<div class="panel-body">
			<div class="tabbable panel-tabs">
				<ul class="nav nav-tabs">
				
					<li class="active"><a data-toggle="tab" href="#panel1"><i class="clip-wrench"></i> Promo</a></li>
					<li><a data-toggle="tab" href="#panel2"><i class="clip-image"></i> Images</a></li>
				...
				<div class="tab-content">
					...
					<div id="panel1" class="tab-pane active">
						<table class="table">
							<?php
								echo form_open_multipart('admin/promo/edit');
								echo form_hidden('promo_id', $row['promo_id']);
							?>
								<tr>
									<td align='right' width='20%'>
										<label class="col-sm-12 control-label" for="form-field-1">BLOG NAME :</label>
									</td>
									<td>
										<div class="col-sm-12">
											<input value="<?php echo $row['judul_promo'];?>" type="text" class="form-control" id="form-field-1" placeholder="*" name="judul_promo" required />
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td>
										<div class="col-sm-12">
											<textarea class="ckeditor form-control" name="deskripsi" id="form-field-6" cols="10" rows="10" placeholder="*" required><?php echo $row['deskripsi'];?></textarea>
										</div>
									</td>
								</tr>
					...
					<div id="panel2" class="tab-pane">
						<table id="mytable2" class="table table-striped table-bordered table-hover">
							...
							<tbody>
								<?php
									$no = 1;
									foreach ($promo_images as $pi){
										echo "<tr>
											<td width='10%' align='center'>".$no."</td>
											<td width='30%' align='center'><img title='".$pi->nama_image."' width='200' src='".base_url().'uploads/promo/'.$pi->image."' /></td>
											<td width='50%'>".$pi->nama_image."</td>
											<td width='10%' align='center'>".
												anchor("admin/promo/delete_image_promo/".$row['promo_id']."/".$pi->image_id, '<i class="fa fa-trash-o"></i> Delete', ["class"=>"btn btn-xs btn-danger tooltips", "data-placement"=>'top', "data-original-title"=>'Delete', "title"=>'Delete', "onclick"=>"return confirm('Are you sure?')"])
											."</td>
										</tr>";
										$no++;
									}
	...
	<div id="modal_input_image" class="modal fade" tabindex="-1" data-focus-on="input:first" style="display: none;">
		<?php 
			echo form_open_multipart('admin/promo/post_image_promo');
			echo form_hidden('promo_id', $row['promo_id']);
		?>
