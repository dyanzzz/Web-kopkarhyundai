			...
			<table class="table">
				...
				?>
					<tr>
						...
						<td>
							<div class="col-sm-12">
								<input type="text" class="form-control" id="form-field-1" placeholder="*" name="nama_slider" required />
							</div>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="col-sm-12">
								<input type="text" class="form-control" id="form-field-2" placeholder="* (Ex. http://hyundaimobil.co.id)" name="link" required />
							</div>
						</td>
					</tr>
									...
									<div class="input-group">
										...
										<div class="input-group-btn">
											<div class="btn btn-light-grey btn-file">
												<span class="fileupload-new"><i class="fa fa-folder-open-o"></i> Select file</span>
												<span class="fileupload-exists"><i class="fa fa-folder-open-o"></i> Change</span>
												<input type="file" id="form-field-5" name="userfile_bg" class="file-input" required/>
											</div>
											<a href="#" class="btn btn-light-grey fileupload-exists" data-dismiss="fileupload">
												<i class="fa fa-times"></i> Remove
											</a>
