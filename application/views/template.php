...
<html lang="en">
	...
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url()?>template/front/assets/css/theme_green.css" type="text/css" id="skin_color">
		<!-- end: MAIN CSS -->
				...
				<div id="slidingbar">
					...
					<div class="col-md-4 col-sm-4">
						<p align='center'>
							...
							<img src="<?php echo get_data_adv_top('link_img');?>" alt="<?php echo get_data_adv_top('nama_adv');?>" width='50%' border="0" />
							</a>
						</p>
					</div>
						...
						<ul class="nav navbar-nav navbar-right">
							...
							<li class="dropdown">
								<a class="dropdown-toggle" href="#" data-toggle="dropdown" data-hover="dropdown">
									<i class="clip-list-2"></i> Merchandise <i class="clip-chevron-down"></i>
								</a>
				...
				<div class="container">
					<div class="row">
						...
						*/
						...
						<div class="col-md-7">
							<p>
								&copy; Copyright 2017 by <?php echo get_data_toko('nama_toko');?>.
							</p>
						</div>
						<?php
						/*
