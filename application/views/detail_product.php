		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-6">
					...
					<a style="background-color:#2f7e49;padding:5px;color:#FFF;" class="btn btn-main-color btn-squared" href="https://api.whatsapp.com/send?phone=<?php echo get_data_toko('wa');?>&amp;text=Assalamualaikum%20admin,%0ASaya%20mau%20order%20<?php echo $product['nama_product'];?>%0A<?php echo base_url()."product/".$product['nama_product_seo'];?>" onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=no,scrollbars=no,height=500,width=600');return false;">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Please contact me to buy this product.</p>
				<p>
